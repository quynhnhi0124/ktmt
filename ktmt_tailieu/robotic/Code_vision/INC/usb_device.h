...
#define USB_CLASS_MISC 0xEF // Miscellaneous (also for bDeviceClass):
// bInterfaceSubclass (bDeviceSubClass):
#define USB_SUBCLASS_MISC1 0x01
// bInterfaceProtocol (bDeviceProtocol):
#define USB_PROTOCOL_ACTIVE_SYNC 0x01 // Active sync
#define USB_PROTOCOL_PALM_SYNC 0x02   // Palm sync
// bInterfaceSubclass (bDeviceSubClass):
